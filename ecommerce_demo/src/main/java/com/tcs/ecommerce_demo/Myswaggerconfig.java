package com.tcs.ecommerce_demo;
...
public class Myswaggerconfig {
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("Ecommerce App").description("API reference guide Ecommerce App").termsOfServiceUrl("https://www.tcs.com/").contact("TCS user").version("1.0").build();	
	}
}